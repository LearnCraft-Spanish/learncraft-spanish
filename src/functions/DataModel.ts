    ...
    // these are used whenenever a page needs to retrieve, update, or create data on quickbase database
    {
      ...
      programs: {
        ...
        fields: [
          ...
          "Name",
          "Lessons",
          "Cohort A Current Lesson",
          "Cohort B Current Lesson",
          "Cohort C Current Lesson",
      ...
      vocabulary: {
        ...
        fields: [
          "Record ID#",
          "word/idiom",
          "Description of Vocabulary/Skill",
          "use",
          "Vocabulary Subcategory - subcategory name",
          "Vocab Name",
          "frequency rank",
          "Verb Infinitive",
          "Conjugation Tags",
