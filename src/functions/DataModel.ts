const qb = { grammar: // quickbaseTablesInfo
  ...
  // these are used whenenever a page needs to retrieve, update, or create data on quickbase database
  {
    ...
    vocabulary: {
      name: 'vocabulary',
      id: 'brrcdgyix',
      fields: ['Record ID#', 'word/idiom', 'Description of Vocabulary/Skill', 'use', 'Vocabulary Subcategory - subcategory name', 'Vocab Name', 'frequency rank', 'Verb Infinitive', 'Conjugation Tags'],
    },
  ...
  memberships: {
    name: 'memberships',
    id: 'bqkmhc9b6',
    fields: ['Record ID#', 'Start Date', 'End Date', 'Active?', 'Related Course', 'Related Student', 'On Hold', 'Last Recorded Week Starts'],
  },
  courses: {
    name: 'courses',
    id: 'bqkmf4h42',
