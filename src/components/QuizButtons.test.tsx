...
function renderQuizButtons() {
  render(<QuizButtons decrementExample={decrementExample} incrementExample={incrementExample} firstExample={false} lastExample={false} />)
}
describe('component QuizButtons', () => {
  ...
  it('disables the Previous button when firstExample is true', () => {
    render(<QuizButtons decrementExample={decrementExample} incrementExample={incrementExample} firstExample lastExample={false} />)
    expect(screen.getByText('Previous').attributes).toHaveProperty('disabled')
  })
  it('disables the Next button when lastExample is true', () => {
    render(<QuizButtons decrementExample={decrementExample} incrementExample={incrementExample} firstExample={false} lastExample />)
