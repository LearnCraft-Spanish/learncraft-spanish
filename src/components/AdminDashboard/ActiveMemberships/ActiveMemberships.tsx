...
import useActiveMembershipsReport, {
  useActiveMembershipsReportByCourse,
} from 'src/hooks/AdminData/useActiveMembershipsReport';
...
function RenderRowForReport(row: any) {
