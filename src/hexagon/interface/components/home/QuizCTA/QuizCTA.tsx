 ...
 * subtitle. The "Today's suggested tool" label sits under the headline
 * inside the dark plate. Sizes are set entirely by CSS at the 768px
 * breakpoint — there is no `compact` prop, since nothing here changes
 * structurally between the two, only measurements.
 */
    ...
    <button type="button" className={styles.root} onClick={onGo}>
      <span className={styles.copy}>
        ...
        <span className={styles.eyebrow}>
          <Eyebrow tone="onDark">Today's suggested tool</Eyebrow>
        </span>
      </span>
