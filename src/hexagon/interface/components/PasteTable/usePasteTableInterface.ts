...
/**
 * Interface-specific hook that adapts the application TableHook for the UI components
 */
export function usePasteTableInterface<T>(hook: TableHook<T>) {
  ...
  // Create the inline style with CSS variable
