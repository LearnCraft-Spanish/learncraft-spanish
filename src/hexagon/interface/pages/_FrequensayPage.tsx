  ...
  return (
    <div className="frequensay">
      ...
      <>
        ...
        <CustomVocabulary
          addManualVocabulary={addManualVocabulary}
          disableManualVocabulary={disableManualVocabulary}
          enableManualVocabulary={enableManualVocabulary}
          userAddedVocabulary={userAddedVocabulary}
          setUserAddedVocabulary={setUserAddedVocabulary}
        />
        ...
        <div className="buttonBox">
          <button type="button" onClick={runFrequensayAnalysis}>
            Submit data for analysis
          </button>
          {frequensayAnalysis && (
            <div>
              <p>{frequensayAnalysis.wordsKnownPercentage}</p>
            </div>
          )}
        </div>
