...
export const {
  mock: mockUseDropoutsByLevelReportQuery,
  override: overrideMockUseDropoutsByLevelReportQuery,
  reset: resetMockUseDropoutsByLevelReportQuery,
} = createOverrideableMock(defaultMockReturn);

export default mockUseDropoutsByLevelReportQuery;
