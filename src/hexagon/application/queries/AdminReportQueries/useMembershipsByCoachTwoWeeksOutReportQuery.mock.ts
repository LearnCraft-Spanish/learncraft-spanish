...
export const {
  mock: mockUseMembershipsByCoachTwoWeeksOutReportQuery,
  override: overrideMockUseMembershipsByCoachTwoWeeksOutReportQuery,
  reset: resetMockUseMembershipsByCoachTwoWeeksOutReportQuery,
} = createOverrideableMock(defaultMockReturn);

export default mockUseMembershipsByCoachTwoWeeksOutReportQuery;
