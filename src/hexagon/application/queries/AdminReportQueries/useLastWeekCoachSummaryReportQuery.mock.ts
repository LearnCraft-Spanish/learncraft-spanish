...
const defaultMockReturn = {
  lastWeekCoachSummaryReportQuery: {
...
export const {
  mock: mockUseLastWeekCoachSummaryReportQuery,
  override: overrideMockUseLastWeekCoachSummaryReportQuery,
  reset: resetMockUseLastWeekCoachSummaryReportQuery,
} = createOverrideableMock(defaultMockReturn);

export default mockUseLastWeekCoachSummaryReportQuery;
