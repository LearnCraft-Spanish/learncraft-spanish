...
// ✅ Domain-specific schema that composes shared schemas
export const AnswerSchema = z.object({
  vocabulary: z.array(VocabularySchema), // Using shared schema
  isCorrect: z.boolean(),
  // ... domain-specific fields
});

// ✅ Domain-specific types that extend/compose shared types
export type EnrichedVocabulary = Vocabulary & {
  difficulty: number;
  frequency: number;
};
```
