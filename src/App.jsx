    ...
    <div className="App" onClick={closeContextualIfClickOut}>
      ...
      {menuReady && (
        <SentryRoutes>
          ...
          <Route exact path="/manage-flashcards" element={((qbUserData.role === 'student')||qbUserData.isAdmin) && <FlashcardManager examplesTable={examplesTable} studentExamplesTable={studentExamplesTable} activeStudent = {qbUserData} removeFlashcard = {removeFlashcardFromActiveStudent} updateExamplesTable = {updateExamplesTable} />} />
